  ...
  if (data) {
    return (
      <div className={"is-detail-Page"}>
        <div
          className="album-detailsHead align-left is-row is-card"
        ...
        <div className="album-detailsBody is-card">
          <div className="album-outline-container">
            <div className="album-outline">
              {console.log("indexn", index ? index : "")}
              <table style={{ width: "100%" }}>
                <tr>
                  <td>First Name: </td>
                  <td>
                    <p>{data["getAllUsers"][0]?.firstName}</p>
                  </td>
                </tr>
                <tr>
                  <td>Last Name: </td>
                  <td>
                    <p>{data["getAllUsers"][0]?.lastName}</p>
                  </td>
                </tr>
                <tr>
                  <td>Email: </td>
                  <td>
                    <p>{data["getAllUsers"][0]?.email}</p>
                  </td>
                </tr>
                <tr>
                  <td>Password</td>
                  <td>
                    <p>{data["getAllUsers"][0]?.password}</p>
                  </td>
                </tr>
                <tbody></tbody>
              </table>
